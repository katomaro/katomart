...
class AfyaInternatoPlatform(BasePlatform):
    """Implements the Afya Internato (Medcel) platform."""
    ...
    def auth_instructions(cls) -> str:
        return """1) Acesse https://alunos-internato.afya.com.br e faça login.
...
""".strip()
    ...
    def _get_default_headers(self) -> Dict[str, str]:
        ...
        return {
            ...
            "Referer": "https://alunos-internato.afya.com.br/",
            "Origin": "https://alunos-internato.afya.com.br",
    ...
    def authenticate(self, credentials: Dict[str, Any]) -> None:
        ...
        if token:
            ...
            logging.info("Sessão autenticada na Afya Internato via token.")
            return
        ...
        self._session = session
        logging.info("Sessão autenticada na Afya Internato via credenciais.")
    ...
    def _fetch_video_data(self, class_id: str, product_id: str) -> Optional[Dict[str, Any]]:
        ...
        headers["X-Host-Origin"] = "https://areaaluno.medcel.com.br"
...
PlatformFactory.register_platform("Afya Internato", AfyaInternatoPlatform)
